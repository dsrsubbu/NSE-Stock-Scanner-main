...
class DataHandler:
    ...
    """
    def __init__(self, stock_list, short_sma=20, long_sma=50, data_path='data', json_path='data.json'):
        """
    ...
    def find_recent_golden_crossovers(self, days_back=7):
        ...
        RSI_WEIGHT = 25
        MACD_WEIGHT = 20
        ADX_WEIGHT = 15 # New weight for ADX
        ...
        for symbol in self.stock_list:
            ...
            if not recent_cross_df.empty:
                ...
                total_confidence = round(recency_score + rsi_score + macd_score + adx_score)
    ...
    def plot_stock_chart_death_cross(self, symbol, days_back=10):
        ...
        mpf.plot(df, type='candle', style='yahoo',
                 ...
                 ylabel='Price (₹)', mav=(self.short_sma, self.long_sma), volume=True,
                 ylabel_lower='Volume',
...
DH = DataHandler(stock_list=my_stocks, short_sma=50, long_sma=200)

# --- Find Golden Crosses (Bullish) ---
print("\n--- Searching for Golden Crosses ---")
golden_cross_data = DH.find_recent_golden_crossovers(days_back=15)
print(golden_cross_data)

# --- Find Death Crosses (Bearish) ---
print("\n--- Searching for Death Crosses ---")
death_cross_data = DH.find_recent_death_crossovers(days_back=15)
...
if isinstance(death_cross_data, pd.DataFrame) and not death_cross_data.empty:
    ...
    DH.plot_stock_chart_death_cross(top_stock_symbol, days_back=15)
